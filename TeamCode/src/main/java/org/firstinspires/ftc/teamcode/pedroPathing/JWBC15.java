...
public class JWBC15 extends OpMode {
    ...
    private final Pose ShootPose = new Pose(47.84530386740332, 95.6, Math.toRadians(134));
    private final Pose ShootPose1 = new Pose(59.29113924050633, 82.59493670886073,Math.toRadians(134));
    ...
    private final Pose Gate = new Pose(16.341772151898734,68.70886075949366,Math.toRadians(90));
    private final Pose GatePickup = new Pose(11.278481012658228,59.81012658227847, Math.toRadians(144));

    private final Pose endpose = new Pose(26.31645569620253, 72, Math.toRadians(90));

    private final Pose intake2Ctrl = new Pose(77.1200433596755,61.277292118329974 );
    private final Pose shoot2Ctrl = new Pose(52.933876494859796,64.70826631232951);
    private final Pose GateShootCtrl = new Pose(64.70826631232951, 64.74852531645568);
    private final Pose intake1Ctrl = new Pose(52.603447793552014, 81.26625382893911);
    private final Pose intake3Ctrl = new Pose(71.27540387439679, 39.0229736345199);
