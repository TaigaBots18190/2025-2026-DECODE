...
public class PID_Controller extends LinearOpMode {
    ...
    // I: 0
    // F: 0.065
    public static double Kp = 0.0014; // Proportional constant
    public static double Ki = 0.0; // Integral constant
    public static double Kd = 0.000021; // derivative constant
    public static double Kf = 0.065; //feedforward constant
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()){
            ...
            joinedTelemetry.addData("Current Position", motor.getCurrentPosition());
